Module WSLUtils
    ...
    Public Function FindLocationsLayer(map As IMap, name As String) As IFeatureLayer
        Dim layer As ILayer
        ...
        For i = 0 To map.LayerCount - 1
            ...
            If (UCase(name) = (UCase(layer.Name))) Then
                ret = layer
                Exit For
            End If
        Next i
    ...
    Public Function FindDEMLayer(map As IMap, name As String) As IRasterLayer
    ...
    Public Function GetElevationByCoord(xPointCoord As Double, yPointCoord As Double, demRaster As IRaster2, interpolation As Boolean) As Double
        ...
        If interpolation Then
            ...
            Dim xTestCoord, yTestCoord As Double
        ...
        'MsgBox("x,y,z: " + xPointCoord.ToString + "  " + yPointCoord.ToString + "   " + z.ToString)
        GetElevationByCoord = z
    End Function

    ' Compute the length of the circle chord
    Public Function GetChordLength(locationSegmentLength As Double, circlePoints As Integer) As Double
        GetChordLength = locationSegmentLength * Math.Sin(2 * WSLUtils.PI() / circlePoints / 2)
    End Function

    ' Compute the chord angle
    Public Function GetChordAngle(circlePoints As Integer) As Double
        GetChordAngle = 360 / circlePoints
    End Function
    ...
    Public Sub log(str As String)
        Dim fn As Integer
        fn = FreeFile()
        FileOpen(fn, WSLConstants.LOG_FILE_NAME, OpenMode.Append)
        PrintLine(fn, str)
        FileClose(fn)
    End Sub
    ...
    Public Function GetSegmentDirectionDegrees(location As WSLPoint, extremePoint1 As WSLPoint, locationSegmentLength As Double) As Double
        ...
        Else
            ...
            Else
                ...
                degrees = 90 - WSLUtils.RadiansToDegrees(Math.Atan(a))
    ...
    Public Function SaveProfileData(o(,) As WSLPoint, m As Integer, n As Integer, fileName As String, Optional separator As String = ",")
        Dim str As String
        Dim fn As Integer
        ...
        str = WSLConstants.HEADER_COL_LOCATION_ID & separator
        str = str & WSLConstants.HEADER_COL_SEGMENT_POINT_ID & separator
        str = str & WSLConstants.HEADER_COL_XCOORD_STRING & separator
        str = str & WSLConstants.HEADER_COL_YCOORD_STRING & separator
        ...
        'MsgBox("m: " + m.ToString + vbCrLf +
        '       "n: " + n.ToString)

        For i = 0 To m - 1
            For j = 0 To n
                point = o(i, j)
                'MsgBox("o    : " + o(i, j).xcoord.ToString + vbCrLf +
                '       "point: " + point.xcoord.ToString)
                PrintLine(fn, i.ToString & separator & j.ToString & separator & point.xcoord.ToString & separator & point.ycoord.ToString & separator & point.elevation.ToString)
            Next j
        Next i
    ...
    Public Function SaveDirectionData(o(,) As WSLPoint, m As Integer, n As Integer, fileName As String, locationSegmentLength As Double, Optional separator As String = ",")
        Dim str As String
        Dim fn As Integer
        Dim location As WSLPoint
        Dim extremePoint1 As WSLPoint
        Dim radius, direction As Double
        ...
        For i = 0 To m - 1
            ...
            PrintLine(fn, i & separator & direction)
        Next i

        FileClose(fn)
    End Function

    Public Function SaveDistanceData(o(,) As WSLPoint, m As Integer, n As Integer, fileName As String, Optional separator As String = ",")
        Dim sum As Double
        Dim dist As Double
        Dim str As String
        Dim fn As Integer
        ...
        ' Header, first column is the distance
        str = WSLConstants.HEADER_COL_DISTANCE_STRING & separator
        For i = 0 To m - 1
            str = str & "P" & i + 1 & separator
        Next i

        PrintLine(fn, str & WSLConstants.HEADER_COL_AVERAGE_STRING)
        ...
        For j = 0 To n
            ...
            For i = 0 To m - 1
                ...
                sum = sum + dist
                str = str & dist & separator
            Next i
            PrintLine(fn, str & sum / m)
        Next j
